...
public class MainActivityShip extends AppCompatActivity {
    Button _data_button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //_ship_button = (Button)findViewById(R.id.tu_qichepiao_chuanpiao);
        //_chaxun = (Button)findViewById(R.id.chaxun);

        _data_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityShip.this, DataActivity.class);
        ...
        _chufa_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityShip.this, CityActivity.class);
        ...
        _zhongdian_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityShip.this, CityActivity_arrive.class);
        ...
        _wode12306_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityShip.this, Wode12306.class);
        ...
        _car_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityShip.this, MainActivity.class);
                startActivity(intent);
            }
        });
        _plane_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivityShip.this, MainActivityPlane.class);
                startActivity(intent);
            }
        });
...
////                editor.commit();
//                editor.apply();
//                Intent intent = new Intent(MainActivityShip.this, ListActivity_Ship.class);
//                startActivity(intent);
//            }
//        });
    }
